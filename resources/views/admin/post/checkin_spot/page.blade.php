...
<h2 class="text-center">จุดเช็คอินกินเที่ยว</h2>

<br>

<button type="button" class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#exampleModal">
    สร้างจุดเช็คอินกินเที่ยว
</button>
...
<div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" style="margin-top: 5%;">
        <div class="modal-content">
            ...
            <form action="{{ route('CheckinSpotCreate') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="modal-body">

                    <div class="mb-3">
                        <input type="hidden" name="post_type_id" value="{{ $postTypes->firstWhere('type_name', 'จุดเช็คอินกินเที่ยว')->id }}">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                ...
                <form action="{{ route('CheckinSpotDelete', $postDetail->id) }}" method="POST" style="display:inline;">
                    @csrf
                    @method('DELETE')

...
<h2 class="text-center">รายงานผลการดำเนินงาน</h2><br>
        ...
        <div class="modal-content">
            ...
            <form action="{{route('PerformanceReportCreate')}}" method="POST">
                ...
                <div class="modal-body">
                    <div class="mb-3">
                        <input type="hidden" name="perf_results_type" value="{{ $perfResultsType->firstWhere('type_name', 'รายงานผลการดำเนินงาน')->id }}">

<style>
    ...
    .bg-coute .text-center:nth-child(1) {
        ...
        /* border-right สำหรับ div แรก */
    }

    .bg-coute .text-center:nth-child(2) {
        border-right: 3px solid #f1f1f1;
        /* border-right สำหรับ div ที่สอง */
    }

    .bg-coute .text-center:nth-child(3) {
        border-right: 3px solid #f1f1f1;
        /* border-right สำหรับ div ที่สาม */
    }

    .bg-coute .text-center:nth-child(5) {
        border-left: 3px solid #f1f1f1;
        /* border-left สำหรับ div ที่ห้า */
    }
    ...
    @media (max-width: 991.98px) {
        .bg-coute .text-center {
            ...
            /* ใช้ !important เพื่อให้มั่นใจว่า border จะหายไป */
        }
    }
    ...
    @media (max-width: 991px) {
        ...
        .container .border-light {
            border: none !important;
            /* ใช้ !important เพื่อทำให้แน่ใจว่า border จะหายไป */
        }
    }
</style>
<!-- Content Section -->
<main class="bg-page10 d-flex">
    <div class="d-flex flex-column justify-content-start align-items-center w-100 gap-4">
        ...
        <div class="bg-coute d-flex flex-column flex-lg-row justify-content-center align-items-center"
            style="border-radius: 15px;">
            <div class="text-center mx-3">
                <span id="online_users" class="fs-1">0</span><br>
                <span class="fw-bold">ขณะนี้</span>
            </div>
            <div class="text-center mx-3">
                <span id="today_users" class="fs-1">0</span><br>
                <span class="fw-bold">วันนี้</span>
            </div>
            <div class="text-center mx-3">
                <span id="month_users" class="fs-1">0</span><br>
                <span class="fw-bold">เดือนนี้</span>
            </div>
            <div class="text-center mx-3">
                <span id="year_users" class="fs-1">0</span><br>
                <span class="fw-bold">ปีนี้</span>
            </div>
            <div class="text-center mx-3">
                <span id="all_users" class="fs-1">0</span><br>
        ...
        <div class="container">
            <div class="d-flex flex-column flex-lg-row justify-content-around align-items-center gap-3 py-3"
                ...
                <div
                    class="d-flex flex-column justify-content-center align-items-start lh-1 gap-2 border border-light border-3 border-bottom-0 border-top-0 px-3">
                ...
                <div
                    class="d-flex flex-column justify-content-center align-items-start lh-1 border border-light border-3 border-bottom-0 border-top-0 border-start-0 px-3">
                ...
                <div class="d-flex flex-column justify-content-center align-items-start lh-1 gap-2 text-link-custom ">
                    <a href="https://webmail.samedtai.go.th/"
                        class="d-flex justify-content-center align-items-start gap-2">
                        <img src="{{ asset('images/section-10/up-arrow.png') }}" alt="email" width="20"
                            height="15">
                        <div>ตรวจสอบEmail</div>
                    </a>
                    <a href="#" class="d-flex justify-content-center align-items-start gap-2">
                        <img src="{{ asset('images/section-10/up-arrow.png') }}" alt="phone" width="20"
                            height="20">

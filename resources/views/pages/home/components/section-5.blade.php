...
.section5-overlay-text {
    ...
    font-weight: bold;
    padding: 10px 15px;
    opacity: 1; /* ทำให้ข้อความไม่แสดงในเริ่มต้น */
    line-height: 1;
    text-align: center;
...
.section5-image-wrapper:hover .section5-overlay-text {
    transform: translate(-50%, -50%) scale(1.1); /* ขยายข้อความเล็กน้อย */
    background-color: rgba(0, 0, 0, 0.7); /* เปลี่ยนพื้นหลังเป็นสีดำเบา ๆ เมื่อ hover */
    color: white; /* เปลี่ยนสีข้อความให้เป็นขาวเมื่อ hover */
}

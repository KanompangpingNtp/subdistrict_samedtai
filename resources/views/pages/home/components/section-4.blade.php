...
<main class="bg-page4 d-flex">
    <div class="container d-flex justify-content-center align-items-center gap-3">
            ...
            <div id="carouselExample" class="carousel slide bg-details p-3" data-bs-ride="carousel"
                ...
                <div class="carousel-inner">
                    ...
                    <div class="carousel-item">
                        <img src="{{ asset('images/section-4/bg-4.png') }}" class="d-block w-100"
                            alt="Slide 2">
                    </div>
                </div>
        ...
        <div class="bg-details p-3">
            <div class="fb-page" data-href="https://www.facebook.com/samedtaibangkla/" data-tabs="timeline" data-width="200"
            data-height="530" data-small-header="false" data-adapt-container-width="false" data-hide-cover="false"

    ...
    <div class="bg py-5">
        <div class="container py-5 custom-gradient-shadow">
            <div class=" d-flex flex-column justify-content-center p-5">
                <div class="fs-1 fw-bold mb-4 text-center" style="color: #77b329;">ป้ายประกาศ <br><span
                        class="fs-3">{{ $noticeBoard->topic_name }}</span></div>
                    ...
                    <div class="row">
                        @foreach ($noticeBoard->photos->whereIn('post_photo_status', ['1', '2']) as $index => $photo)
                            <div class="col-lg-3 col-md-4 col-sm-6 col-12 mb-3 text-center">
                                ...
                                <img src="{{ asset('storage/' . $photo->post_photo_file) }}" alt="รูปแนบ"
                                ...
                                <div class="modal-dialog modal-lg modal-dialog-centered">
                                    <div class="modal-content">
                                        <div class="modal-body text-center">
                                            <img src="{{ asset('storage/' . $photo->post_photo_file) }}" class="img-fluid"

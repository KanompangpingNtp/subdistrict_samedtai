...
<div class="bg py-5">
    <div class="container py-5 custom-gradient-shadow">
        <div class=" d-flex flex-column justify-content-center p-5">
            ...
            <table class="table">
                <tr>
                    <td><a href="{{route('page1')}}">ฟอร์มส่งคำร้องทั่วไป</a></td>
                </tr>
                <tr>
                    <td><a href="{{route('page2')}}">แบบยืนยันเบี้ยยังชีพผู้สูงอายุ</a></td>
                </tr>
                <tr>
                    <td><a href="{{route('page3')}}">แบบคำขอลงทะเบียนรับเงินเบี้ยความพิการ</a></td>
                </tr>
                <tr>
                    <td><a href="{{route('page4')}}">แบบคำขอรับการสงเคราะห์ (ผู้ป่วยเอดส์)</td>
                </tr>
            </table>

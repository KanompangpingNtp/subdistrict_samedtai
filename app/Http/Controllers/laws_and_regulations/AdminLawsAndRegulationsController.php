...
class AdminLawsAndRegulationsController extends Controller
{
    public function LawsAndRegulationsType()
    {
        ...
        return view('admin.laws_and_regulations.page_type', compact('LawsRegsType'));
    }
    ...
    public function LawsAndRegulationsShowSection($id)
    {
        ...
        return view('admin.laws_and_regulations.page_section', compact('LawsRegsType', 'LawsRegsSection'));
    }
    ...
    public function LawsAndRegulationsShowDetails($id)
    {
        ...
        return view('admin.laws_and_regulations.page_detail', compact('LawsRegsSection', 'LawsRegsFiles'));
    }

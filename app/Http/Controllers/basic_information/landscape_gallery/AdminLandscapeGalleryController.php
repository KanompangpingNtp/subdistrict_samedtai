...
class AdminLandscapeGalleryController extends Controller
{
    public function  LandscapeGalleryAdmin()
    {
        ...
        return view('admin.basic_information.landscape_gallery.page', compact('basicInfoDetail', 'basicInfoType'));
    }

    public function LandscapeGalleryCreate(Request $request)
    {
        $request->validate([
    ...
    public function LandscapeGalleryDelete($id)
    {

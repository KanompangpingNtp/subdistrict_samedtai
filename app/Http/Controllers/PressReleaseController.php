...
class PressReleaseController extends Controller
{
    ...
    public function PressReleaseShowDetails($id)
    {
        ...
        return view('pages.press_release.show_detail', compact('PublicMenus','pressRelease', 'personnelAgencies', 'PerfResultsMenu', 'AuthorityMenu', 'OperationalPlanMenu', 'LawsRegsMenu'));
    }
}
